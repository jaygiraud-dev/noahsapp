...
export const QUESTS: Quest[] = [
  ...
  // ——— TRENDING SIDE QUESTS (the fun, "main character" kind) ———
  { id: 'q-trashtag', title: 'The Trash Bag Run', type: 'Social', difficulty: 'medium', stats: { soul: 3, personality: 2 }, emoji: '🗑️', desc: 'Grab bags, grab friends, and leave a park better than you found it. The trashtag glow-up — your before/after photo is the whole flex.' },
  { id: 'q-ruck', title: 'Join the Ruck Club', type: 'Health', difficulty: 'medium', stats: { body: 4 }, emoji: '🎒', desc: 'Load a backpack, walk far, get quietly strong. The most underrated workout on earth is just walking with weight on.' },
  { id: 'q-runclub', title: 'Join a Run Club', type: 'Social', difficulty: 'medium', stats: { body: 3, personality: 2 }, emoji: '🏃‍♂️', desc: 'Run clubs are the new night clubs. Show up alone, leave with a crew, a runner\'s high, and three new numbers in your phone.' },
  { id: 'q-plunge', title: 'Polar Plunge', type: 'Adventure', difficulty: 'hard', stats: { body: 5, soul: 3 }, emoji: '🧊', desc: 'Find cold open water and get all the way in. Screaming is optional, the bragging rights are not.' },
  { id: 'q-balloon', title: 'Ride a Hot Air Balloon', type: 'Adventure', difficulty: 'epic', stats: { soul: 10, personality: 4 }, emoji: '🎈', desc: 'Drift over the waking world at sunrise in a wicker basket. Terrifying, silent, and impossible to forget.' },
  { id: 'q-laststop', title: 'Ride to the Last Stop', type: 'Adventure', difficulty: 'medium', stats: { soul: 2, mind: 2 }, emoji: '🚆', desc: 'Take the train to the final station and explore wherever you land. Let the map make the plans for once.' },
  { id: 'q-waterfall', title: 'Chase a Waterfall', type: 'Adventure', difficulty: 'hard', stats: { body: 4, soul: 4 }, emoji: '💦', desc: 'Hike to the falls and swim in the cold roar of it. Nature\'s best shower, earned with your own two legs.' },
  { id: 'q-bookbar', title: 'Read a Book in a Bar', type: 'Hobby', difficulty: 'easy', stats: { mind: 2, personality: 1 }, emoji: '📕', desc: 'One drink, one paperback, zero phone. The most quietly mysterious main-character move there is.' },
  { id: 'q-karaoke', title: 'Sing Karaoke', type: 'Social', difficulty: 'hard', stats: { personality: 7 }, emoji: '🎤', desc: 'Grab the mic, butcher the high note, own the room anyway. Stage fright dies one off-key chorus at a time.' },
  { id: 'q-midnightswim', title: 'Midnight Swim', type: 'Adventure', difficulty: 'medium', stats: { personality: 3, soul: 2 }, emoji: '🌊', desc: 'Slip into the water under the stars with people you love. A little reckless, a lot alive.' },
  { id: 'q-rawdog', title: 'Raw-Dog a Flight', type: 'Mind', difficulty: 'hard', stats: { mind: 6, soul: 3 }, emoji: '✈️', desc: 'No screen, no music, no nap — just you and your own mind for the whole flight. The internet\'s favourite impossible dare.' },
  { id: 'q-hotones', title: 'Order the Spiciest Thing', type: 'Social', difficulty: 'medium', stats: { personality: 3, body: 1 }, emoji: '🌶️', desc: 'Find the dish with the skull next to it and finish the whole plate. The tears are part of the lore.' },
  { id: 'q-skydive', title: 'Jump Out of a Plane', type: 'Adventure', difficulty: 'epic', stats: { personality: 14, soul: 6 }, emoji: '🪂', desc: 'Skydiving — the ultimate "I can do terrifying things" receipt. Everything in life after feels a little easier.' },
  { id: 'q-roadtrip', title: 'No-Map Road Trip', type: 'Adventure', difficulty: 'hard', stats: { soul: 5, personality: 3 }, emoji: '🚗', desc: 'Pick a direction, not a destination. Windows down, tank full, plans gloriously empty.' },
  { id: 'q-concertsolo', title: 'Go to a Show Alone', type: 'Social', difficulty: 'medium', stats: { personality: 4 }, emoji: '🎶', desc: 'See the band by yourself. No one to impress, nobody to wait on — every single song just for you.' },
  { id: 'q-busk', title: 'Busk for an Hour', type: 'Adventure', difficulty: 'epic', stats: { personality: 12, mind: 2 }, emoji: '🎸', desc: 'Open the case, play for strangers, keep whatever lands inside. Vulnerability turned into an actual sport.' },
  { id: 'q-tourist', title: 'Tourist in Your Own City', type: 'Adventure', difficulty: 'easy', stats: { soul: 2, mind: 1 }, emoji: '📸', desc: 'Do the cheesy landmark, the open-top bus, the overpriced gift shop. Fall back in love with where you already live.' },
  { id: 'q-darksky', title: 'Chase Dark Skies', type: 'Soul', difficulty: 'medium', stats: { soul: 3, mind: 1 }, emoji: '🌌', desc: 'Drive past every city light until the Milky Way finally shows up. Remember exactly how big all of this is.' },
  { id: 'q-sunrise-rave', title: 'Dance Till Sunrise', type: 'Adventure', difficulty: 'hard', stats: { personality: 6, soul: 2 }, emoji: '🪩', desc: 'Festival, club, or your own kitchen — move until the sun comes up and the whole night becomes a story you tell for years.' },
  { id: 'q-taco', title: 'Crown the Best Cheap Eat', type: 'Adventure', difficulty: 'easy', stats: { soul: 1, personality: 1 }, emoji: '🌮', desc: 'Hunt your city for its greatest hole-in-the-wall and declare a winner. A delicious quest with delicious data.' },
  { id: 'q-ferrata', title: 'Climb a Cliff (Via Ferrata)', type: 'Adventure', difficulty: 'epic', stats: { body: 10, personality: 6 }, emoji: '🧗', desc: 'Clip into the cable and scale a sheer rock face on iron rungs. All the adrenaline of climbing something enormous — roped, legal, and unforgettable.' },
];
