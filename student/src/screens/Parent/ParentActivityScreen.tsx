...
const styles = StyleSheet.create({
  ...
  clearBtn: { borderRadius: 34, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 6 },
  ...
  iconWrap: { width: 36, height: 36, borderRadius: 28, justifyContent: 'center', alignItems: 'center' },
  icon: { fontSize: 16 },
